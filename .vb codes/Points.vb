...
Public Class Points
    ...
    Public Function randmgenerator(maxnum As Integer) As Integer
    ...
    Public Function Wordpicker(Table_name As String) As String

        Word1 = Categories(Table_name)(randmgenerator(Categories(Table_name).Count))
        ...
        Else
            ...
            Word2 = Categories(Table_name)(randmgenerator(Categories(Table_name).Count))
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        My.Settings.Score = 2
        My.Settings.Table = My.Settings.Table & "-Easy"
        Wordpicker(My.Settings.Table)
        My.Settings.Save()
        lbltxt()
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        My.Settings.Score = 6
        My.Settings.Table = My.Settings.Table & "-Med"
        Wordpicker(My.Settings.Table)
        My.Settings.Save()
        lbltxt()
        Game.Label5.Text = ""
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        My.Settings.Score = 7
        My.Settings.Table = My.Settings.Table & "-Hard"
        Wordpicker(My.Settings.Table)
        My.Settings.Save()
        lbltxt()
        Game.Label5.Text = ""
